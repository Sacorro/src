package net.minecraft.vanity.gui.altmanager;
...
public class AltSwitch extends GuiScreen
{
    public String failed;
    public static boolean showStatus;
    public AltSwitch(GuiScreen guiscreen)
    {
        m_gParent = guiscreen;
    }
    ...
    public void initGui()
    {
        ...
        serverTextField2 = new GuiPasswordField(fontRenderer, width / 2 - 100, 116, 200, 20);
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        drawCenteredString(fontRenderer, ("Premium Account Login"), width / 2, (height / 4 - 60) + 20, 0xffffff);
    ...
    private GuiPasswordField serverTextField2;
