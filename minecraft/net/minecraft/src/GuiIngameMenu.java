...
import net.minecraft.vanity.gui.pause.VanityPaused;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(69, width /2 - 100, height / 4 + 48 + byte0, StatCollector.translateToLocal("Vanity")));
