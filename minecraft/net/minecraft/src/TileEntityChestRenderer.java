...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityChestAt(TileEntityChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        ...
        boolean PosiZ = par1TileEntityChest.adjacentChestZPos != null;
        boolean NegZ = par1TileEntityChest.adjacentChestZNeg != null;
        if(Vanity.chestesp)
        {
	        if(PosiX)
	     	   ESP.chestESP(par2 + 1, par4, par6, 1F);
	        else
	        if(NegX)
	     	   ESP.chestESP(par2 - 1, par4, par6, 1F);
	        else
	        if(PosiZ)
	     	   ESP.chestESP(par2, par4, par6 + 1, 1F);
	        else
	        if(NegZ)
	     	   ESP.chestESP(par2, par4, par6 - 1, 1F);
	        
	        ESP.chestESP(par2, par4, par6, 1F);
        }
    }
