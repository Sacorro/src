...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    public void updateCloak()
    {
    	/** START Vanity CODE **/
	    try{
			    	if(Vanity.protectHashMap.containsKey(username) || Minecraft.thePlayer.username == username)
			    	{
			    		playerCloakUrl = ("http://dl.dropbox.com/u/49291117/pics/capes/avocape.png");
    ...
    {
    	if(Vanity.POGMembers.containsKey(username))
    	{
    		Vanity.isPOGMember = true;
    	}
        if (flyToggleTimer > 0)
        {
            flyToggleTimer--;
    ...
    {
        return !sleeping && super.isEntityInsideOpaqueBlock() && !Vanity.freecam;
    }
