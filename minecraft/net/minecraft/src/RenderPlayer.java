...
public class RenderPlayer extends RenderLiving
{
    ...
    protected void renderName(EntityPlayer par1EntityPlayer, double par2, double par4, double par6)
    {
        if (Minecraft.isGuiEnabled() && par1EntityPlayer != renderManager.livingPlayer)
        {
            ...
            float f3 = par1EntityPlayer.isSneaking() ? 64F : 64F;
            ...
            if (f2 < f3)
            {
                ...
                if(Vanity.protect)
                {
	                if(Vanity.protectHashMap.containsKey(s))
	                {
	                	s = (String) Vanity.protectHashMap.get(s2);
	                }
                }
                if (!par1EntityPlayer.isSneaking())
                {
                    ...
                    {
                        renderLivingLabel(par1EntityPlayer, s, par2, par4 - 1.5D, par6, 64, 0xffffff);
                    }
                    else
                    {
                        renderLivingLabel(par1EntityPlayer, s, par2, par4, par6, 64, 0xffffff);
                    }
                }
                else
                {
                    ...
                    fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2, -10, 0xffff0000);
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (par1EntityPlayer.username.equals("xXGravyPopXx") && loadDownloadableImageTexture(par1EntityPlayer.skinUrl, null))
        {
            for (int i = 0; i < 2; i++)
            {
