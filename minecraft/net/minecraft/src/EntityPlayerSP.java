...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    {
    	/** VANITY **/
    	boolean flag = Vanity.fly;
    	boolean flag1 = Keyboard.isKeyDown(Keyboard.KEY_SPACE);
    	boolean flag2 = Keyboard.isKeyDown(Keyboard.KEY_LSHIFT);
    	if(flag){
    		par1 *= Vanity.flySpeedXZ;
    		par3 = 0F;
        	par5 *= Vanity.flySpeedXZ;
        	if(flag1)
        	{
        		par3 = Vanity.flySpeedY;
        	}
        	else if(flag2)
        	{
        		par3 = -Vanity.flySpeedY;
	     ...
	     if (Vanity.sprint && !mc.thePlayer.isJumping)
	      {
		       if (Vanity.sprint) setSprinting(true);
		       par1 *= Vanity.nocheat ? 1.2F : 1.2f * Vanity.speed;
		       par5 *= Vanity.nocheat ? 1.2F : 1.2f * Vanity.speed;
	      }
    ...
    public void onLivingUpdate()
    {
        ...
        if (isSprinting() && (movementInput.moveForward < f || !flag2))
        {
            setSprinting(false);
        }
