...
import net.minecraft.vanity.gui.altmanager.AltSwitch;
...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        /** VANITY **/
        controlList.add(new GuiButtonLanguage(12, width / 2 - 124, i + 60 + 12));
        if (mc.session == null)
        {
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
        	mc.displayGuiScreen(new AltSwitch(this));
        }
    }
