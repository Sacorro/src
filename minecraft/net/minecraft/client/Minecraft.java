...
import net.minecraft.vanity.hacks.Nuker;
...
public abstract class Minecraft implements Runnable
{
    ...
    public void startGame() throws LWJGLException
    {
        ...
        try {
		 ...
		 Vanity.POGMembers.put("zencantsnipe", "ZCS");
		 Vanity.POGMembers.put("Stl_Missouri", "Stl");
		 Vanity.POGMembers.put("xXGravyPopXx", "Graveee");
		 Vanity.POGMembers.put("WorldHippie", "WorldHippie");
		 Vanity.POGMembers.put("bluedick", "Hypnotize");
		 Vanity.POGMembers.put("pRoDiGy_4D4M", "Adam");
		 Vanity.POGMembers.put("haterz16", "Shnitzel");
        if (mcCanvas != null)
        {
    ...
    private void clickMouse(int par1)
    {
        ...
        {
        	/** VANITY **/
            rightClickDelayTimer = (int) Vanity.place;
        }
        ...
        else if (objectMouseOver.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            /** VANITY **/
            if(Vanity.nukercreative)
            {
                 int BlockHit = theWorld.getBlockId(i, j, k);
                 Nuker.StartBotter(i, j, k, BlockHit);
            }
            if (par1 == 0)
            {
    ...
    public static void startMainThread(String par0Str, String par1Str, String par2Str)
    {
        ...
        {
            minecraftimpl.session = new Session(("PureMind"), "");
        }
